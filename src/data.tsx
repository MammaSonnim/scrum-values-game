export const quizData = [
  {
    ...
    answers: [
      ...
      },
      {
        ...
        comment: 'Данный ответ никак не решает проблему. Состояние ценностей не поменялось. Обсудите эту ситуацию с командой и двигайтесь дальше по игре',
      },
      {
        id: 3,
