  ...
  },
  {
    ...
    answers: [
      ...
      },
      {
        id: '3',
        text:
          'Подумать о том, какие вещи нужно будет сделать, если завтра половина команды уйдёт в длительный отпуск',
        scores: {
          courage: 0,
          focus: 2,
          commitment: 0,
      ...
      },
      {
        id: '4',
        text:
          'Владельцу Продукта создать vision и стратегию продукта, роадмап развития и рассказать это команде и после этого получить цель спринта',
        scores: {
          courage: 0,
          focus: 2,
          commitment: 3,
  ...
  },
  {
    ...
    answers: [
      ...
      },
      {
        id: '2',
        text:
          'Позвать бизнес-заказчиков на Ретроспективу и показать им проблему и её последствия',
        scores: {
          courage: -2,
          focus: 0,
          commitment: -1,
      ...
      },
      {
        id: '3',
        text:
          'Конечных пользователей на Обзор зовёт Скрам-мастер или сама команда',
        scores: {
          courage: 1,
          focus: 0,
          commitment: 2,
      ...
      },
      {
        id: '4',
        text:
          'Обсудить тет-а-тет ситуацию с Владельцем Продукта, узнать, почему не решается менять ситуацию. Убедить рассказать команде',
        scores: {
          courage: 1,
          focus: 0,
          commitment: 0,
